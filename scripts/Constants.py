...
outhosp_mort_pairs = [[0, 6],[0, 12],[3, 12],[0, 24], [6, 24]]
targets={
    'phenotype_first': ['Acute and unspecified renal failure',
    ...
    'phenotype_all': ['Acute and unspecified renal failure',
                'Acute cerebrovascular disease',
                'Acute myocardial infarction',
                'Cardiac dysrhythmias',
                'Chronic kidney disease',
    ...
    'inhosp_mort': ['inhosp_mort'],
    'outhosp_mort': ["%s%smortality"%(beg, end) for beg, end in outhosp_mort_pairs]
}
